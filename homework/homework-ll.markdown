...
The name of the submission should be **homework4.cpp**, no numbers, no name, no capital letters.
...
Given the above classes write  a program which implements the function "sorted_insert"
