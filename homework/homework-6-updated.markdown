...
Set the initial balance to be 100.
Withdraw 20 from MoneyMarketAccount.
New balance: 80
Withdraw -20 from MoneyMarketAccount. 
This should give an appropriate error message.
Withdraw from MoneyMarketAccount(again): 30
That worked. New balance: 50

Create CDAccount
CDAccount balance: 50
CDAccount interest rate: 0.5

Deposit into CDAccount account: 30
That worked.
CDAccount new balance: 80. (25% penalty 0.25 * (0.5*80))

Call transfer function from CDAccount to MoneyMarketAccount. Amount : 60 
CDAccount new balance: 10
MoneyMarketAccount new balance: 110
Enter amount to transfer from MoneyMarketAccount to CDAccount: 100
That worked.
CDAccount new balance: 110
MoneyMarketAccount new balance: 8.5 (withdrawl fee)
</pre>
